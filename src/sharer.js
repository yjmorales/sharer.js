...
class Sharer {
  ...
  init() {
    if (document.readyState === 'complete' || document.readyState !== 'loading') {
      ...
      elems.map(i => i.addEventListener('click', this.add));
    } else {
  ...
  getValue(attr) {
    let val = this.elem.getAttribute('data-' + attr); // handing facebook hashtag attribute
  ...
  share() {
    ...
    const sharers = {
        ...
        line: {
          shareUrl: 'http://line.me/R/msg/text/?' + encodeURIComponent(this.getValue('title') + ' ' + url),
          isLink: true
        },
        pinterest: {
